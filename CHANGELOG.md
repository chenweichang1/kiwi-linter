...
- **修复误删翻译**：批量提交时只从 en/zh_TW 文件删除实际新增或更新的 key，内容未变而被跳过的 key 不再被误删英文和繁体翻译
- **英文保留精确到 key**：已手动提供英文的 key 按 key 粒度跳过 en 文件删除，未提供英文的变更 key 仍正常触发重新翻译
- **同文件 action 合并**：同一 commit 中 en 文件的新增与删除变更合并为一个 action，避免互相覆盖
...
- **单次提交优化**：中文、英文文案和其他语言 key 删除合并为一个 commit，避免多次提交导致的竞态问题
- **英文 key 保留**：已手动提供英文翻译的 key 不再从 en 文件中被误删
- **重构提交架构**：引入 `prepareFileChange` + `batchCommitFiles` 机制，先准备所有变更再统一提交
...
[Unreleased]: https://github.com/chenweichang1/kiwi-linter-idea/compare/v1.0.6...HEAD
[1.0.6]: https://github.com/chenweichang1/kiwi-linter-idea/compare/v1.0.5...v1.0.6
[1.0.5]: https://github.com/chenweichang1/kiwi-linter-idea/compare/v1.0.4...v1.0.5
[1.0.4]: https://github.com/chenweichang1/kiwi-linter-idea/compare/v1.0.2...v1.0.4
[1.0.2]: https://github.com/chenweichang1/kiwi-linter-idea/compare/v1.0.1...v1.0.2
